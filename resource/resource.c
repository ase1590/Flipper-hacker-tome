...
Topic hack_knowledge[] = {
    {"What The Flipper Is For", NULL, APP_ASSETS_PATH("flipperuse.txt")},
    {"BLE Spam", NULL, APP_ASSETS_PATH("blespam.txt")},
    {"Asking Good Hacker Q's", NULL, APP_ASSETS_PATH("askquestions.txt")},
    {"How to Get Arrested", NULL, APP_ASSETS_PATH("arrested.txt")},
...
Chapter chapters[] = {
    ...
    {"Flipper Hacker Knowledge", hack_knowledge, sizeof(hack_knowledge) / sizeof(Topic)},
};
